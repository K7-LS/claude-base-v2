...
def _build_desired_state(repo_root: Path, contract: dict[str, object]) -> dict[str, object]:
    ...
    return {
        ...
        "hooks": ["SessionStart:startup:check-release"],
        "managed_files": [
...
def load_client_acceptance(
    ...
    if (
        ...
        not in {"official-binary", "official-release-assets"}
...
def build_release_from_source(
    ...
    baseline = {
        ...
        "manifest_sha256": _sha256(session_tools.manifest_bytes),
