---
name: sync-base
description: Проверить и установить стабильный Claude-base release по одностороннему каналу.
...
powershell.exe -NoProfile -ExecutionPolicy Bypass -File `
  "$HOME\.claude\skills\sync-base\tools\sync_base.ps1" `
  -PolicyPath "$HOME\.claude\skills\sync-base\sync-policy.json"
```

1. Выбери последний стабильный `claude-vX.Y.Z`.
