...
В рамках импорта из <организация> аудита (см. аудит <организация> (от 2026-05-20, отчёт архивирован),
...
### Что плагин даёт (из артефактов <организация>)

В базе <организация> видна папка `.superpowers/brainstorm/27652-1777236788/` с
runtime-кэшем:
...
- третий R&D-плагин из roadmap'а (4.7) отложен из-за отсутствия tmux — заметка
  осталась в наследии базы, в V2 не переносится
- семантические тесты вывода агентов (promptfoo) — там же
- <организация> отчёт аудит <организация> (от 2026-05-20, отчёт архивирован), разделы 4.6 и 4.8
